...
public class PlayState extends FlxState{
	...
	protected FlxText scoreLabel = new FlxText(0, 0, 100, "SCORE:");
	...
	public PlayState() {
		// TODO Auto-generated constructor stub
		  ...
		  addEnemies();
		  addControls();
		  scoreLabel.setFormat(Typeface.DEFAULT_BOLD, 20, Color.BLUE, Align.LEFT);
		  add(scoreLabel);
		  
		  FlxG.play(R.raw.startgame);
	...
	private void addLevelBlocks() {
		...
		title_bar.loadGraphic(R.drawable.transparent);
